...
class ContatoModelTest(TestCase):
    ...
    def test_contato_creation(self):
        ...
        self.assertEqual(self.contato.email, "mariavitoria@email.com")
        self.assertEqual(self.contato.telefone, "12345678900")
        self.assertEqual(self.contato.endereco, "Rua Exemplo, 123")

    def test_contato_str(self):
        """Testa o método __str__ de Contato."""
        self.assertEqual(str(self.contato), "mariavitoria@email.com")
    ...
    def test_email_duplicado(self):
        ...
        with self.assertRaises(ValidationError):
            contato_duplicado = Contato(
                dados_pessoais=self.dados_pessoais,
                email="mariavitoria@email.com",  # Email já existe
                telefone="0987654321",
                endereco="Rua Outro, 123"
            )
